package com.kxl.recyclerviewrefreshdemo;/**
 * @author by atu
 **/
...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public class AutoLoadAdapter extends RecyclerView.Adapter<ViewHolder> {
        /**
         * 数据adapter
         */
        ...
        public AutoLoadAdapter(Adapter mInternalAdapter) {
